...
const FoodItem = ({ image, title, description, price, foodType }: FoodItemProps) => {
    ...
    return (
        <div className="bg-white border border-gray-100 transition transform duration-700 hover:shadow-xl hover:scale-105 p-4 rounded-lg relative">
            ...
            <Image className="w-64 mx-auto transform transition duration-300 hover:scale-105" src={image} alt="" width={1184} height={1182} />
